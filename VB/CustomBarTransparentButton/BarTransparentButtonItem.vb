...
Namespace CustomTransparentBarItem
	Public Class BarTransparentButtonItem
        ...
        <Description("Gets or sets the large image displayed within associated links when they are pressed."), System.ComponentModel.DefaultValue(GetType(Object), Nothing), Category("Appearance")> _
